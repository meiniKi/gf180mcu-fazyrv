...
module wb_spi_conf #(
  ...
  output [3:0] o_Cntrl_presc,
  output o_Cntrl_cpol,
  output o_Cntrl_auto_cs,
  output [1:0] o_Cntrl_size
);
  wire w_register_valid;
  wire [1:0] w_register_access;
  wire [1:0] w_register_address;
  wire [31:0] w_register_write_data;
  wire [31:0] w_register_strobe;
  wire [0:0] w_register_active;
  wire [0:0] w_register_ready;
  wire [1:0] w_register_status;
  wire [31:0] w_register_read_data;
  wire [31:0] w_register_value;
  rggen_wishbone_adapter #(
    .ADDRESS_WIDTH        (ADDRESS_WIDTH),
    .LOCAL_ADDRESS_WIDTH  (2),
    .BUS_WIDTH            (32),
    .REGISTERS            (1),
